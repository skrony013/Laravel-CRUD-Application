		...
		<div class="page-header">
			<div class="row align-items-center">
				<div class="col">
					...
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{ url('services/categories') }}">Categories</a>
						</li>
		...
		<div class="row">
			<div class="col-xl-8 d-flex offset-1">
				<div class="card flex-fill">
					...
					<div class="card-body">
						<form action="{{ url('services/categories/update-category/'.$cat_data->id) }}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<textarea name="cat_desc" class="form-control" id="" rows="3">
										{{ $cat_data->cat_desc }}
									</textarea>
								</div>
							</div>
