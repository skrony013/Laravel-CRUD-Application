	...
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row align-items-center">
				...
				<div class="col-auto">
					<a href="{{ url('/services/add-service') }}" class="btn btn-primary mr-1">
							...
							<table class="table table-center table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{ $service_item->service_short_desc }}</td>
										<td>
											<img src="{{url('upload/service/'.$service_item->service_img)}}" class="img-fluid" style="width:110px; height: 70px;" alt="">
										</td>
										...
										<td class="text-right">
											<a href="{{ url('services/edit-service/'.$service_item->id) }}" class="btn btn-sm btn-white text-success mr-2"><i class="far fa-edit mr-1"></i> Edit</a>
											<a href="{{ url('services/delete-service/'.$service_item->id) }}" class="btn btn-sm btn-white text-danger mr-2"><i class="far fa-trash-alt mr-1"></i>Delete</a>
										</td>
									</tr>
									@endforeach
